...
const ProductCard = () => {
    return (<ProductCardWrapper>
        <Container>
            ...
            <Swiper slidesPerView={5} spaceBetween={0} slidesPerGroup={1} loop={true} loopFillGroupWithBlank={true} pagination={{ "clickable": true }}
                navigation={true} className="mySwiper">
                {SwiperData.map((v, i) => {
                    return <SwiperSlide className="border border-primary h-100 p-3" key={i}>
